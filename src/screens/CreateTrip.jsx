...
export default function CreateTrip({ store }) {
  ...
  return <main className="onboarding-page">
    ...
    <section className="onboarding-card">
      ...
      <span className="eyebrow">Freedom Travel OS P</span>
      ...
      <small>You can create more trips later. Each trip stays separate on this device unless you export a backup.</small>
    </section>
  </main>;
}
