...
import { getDaysUntil, formatFlightCountdown } from "../utils/helpers";
...
export default function Dashboard({ store, setActivePage }) {
  ...
  const flightCountdown=formatFlightCountdown(trip.flight.departureDate,trip.flight.departureTime);
  return <Page>
