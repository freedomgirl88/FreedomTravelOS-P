...
export function useTripStore(){
  ...
  const { trip, packing, expenses, days, selectedDay, visited, favourites, bookings, memories, reminders = [], documents = [], emergencyContacts = [] } = record;
  ...
  return {workspace,trips:workspace.trips.map(({id,trip,updatedAt})=>({id,trip,updatedAt})),activeTripId:workspace.activeTripId,hasTrips:workspace.trips.length>0,trip,packing,expenses,days,selectedDay,setSelectedDay,visited,favourites,bookings,memories,packed,packingProgress,spentSGD,remainingSGD,activeDay,activeVisited,exploreProgress,ready,createTrip,switchTrip,deleteTrip,updateTripField,updateFlightField,updateHotelField,updateReturnFlightField,clearFlight,clearHotel,togglePacking,addPackingItem,updatePackingItem,deletePackingItem,addExpense,updateExpense,deleteExpense,toggleVisited,toggleFavourite,addBooking,updateBooking,deleteBooking,addMemory,updateMemory,toggleMemoryFavourite,deleteMemory,reminders,addReminder,updateReminder,toggleReminder,deleteReminder,documents,addDocument,updateDocument,deleteDocument,emergencyContacts,addEmergencyContact,updateEmergencyContact,deleteEmergencyContact,addExploreDay,updateExploreDay,deleteExploreDay,addExplorePlace,updateExplorePlace,deleteExplorePlace,moveExplorePlace,resetActiveTrip,resetAll};
}
