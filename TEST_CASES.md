...
## v0.7.0 Flight Status & Countdown
- Add an outbound flight and confirm the Dashboard shows the flight countdown.
- Confirm the Flight screen shows status, countdown, boarding time, terminal, gate and seat.
- Update the status to Delayed or Boarding and confirm the badge and note are saved after refresh.
- Confirm the journey timeline calculates check-in, airport arrival, boarding, departure and arrival.
- Confirm existing flights without the new fields still load as Scheduled without data loss.
